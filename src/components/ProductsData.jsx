...
const Products = () => {
    const data = [
        { img: 'https://www.course-api.com/images/cart/phone-1.png', name: 'Samsung Galaxy S8', price: 799.99, items: 1 },
        { img: 'https://www.course-api.com/images/cart/phone-2.png', name: 'Google Pixel', price: 499.99, items: 1 },
        { img: 'https://www.course-api.com/images/cart/phone-3.png', name: 'Xiaomi Redmi Note 2', price: 699.99, items: 1 },
        { img: 'https://www.course-api.com/images/cart/phone-4.png', name: 'Samsung Galaxy S7', price: 599.99, items: 1 }
    ];
    ...
    const onDecrease = (idx) => {
        setArr(prevArr => 
            prevArr
                ...
                .filter(item => item.items > 0) // Automatically remove items with 0 count
        );
    };
